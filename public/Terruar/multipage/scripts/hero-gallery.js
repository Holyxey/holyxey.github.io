// multipage/scripts/hero-gallery.ts
var node = document.getElementById("heroImageBlock");
var list = [
...
function createArrow(is) {
  ...
  wrapper.style.borderRadius = is === "next" ? "20px 0 0 20px" : "0 20px 20px 0";
  switch (is) {
    case "next":
...
function insertImage(url, wrapper) {
  const img = document.createElement("img");
  img.alt = "Новый год в Terruar. Глэмпинг Терруар под Москвой в Тульской области";
  img.src = url;
