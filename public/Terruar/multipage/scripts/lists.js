const lists = {
    servicesList: [
        ...
        },
        {
            ...
            images: ['https://static.tildacdn.com/tild6362-6161-4065-b664-366466393761/pexels-photo-688660.jpeg'],
            popUp: true,
            popUpType: 'service',
            readMoreLink: '',
            readMoreText: 'Подробнее',
        ...
        },
        {
            ...
            images: ['https://thumb.tildacdn.com/tild3735-3330-4034-a133-343665313739/-/format/webp/pexels-photo-7507966.jpeg'],
            popUp: true,
            popUpType: 'service',
            readMoreLink: '',
            readMoreText: 'Подробнее',
        ...
        },
        {
            ...
            price: '',
            shortDescr: '500р/час',
            fullDescr: 'Исследуйте местные окрестности на лыжах – это особенно приятно, по зимнему лесу',
            benefits: ['', '', ''],
            images: ['https://thumb.tildacdn.com/tild3335-3365-4063-a239-646365313532/-/format/webp/Frame_8.png',
            ],
            popUp: true,
            popUpType: 'service',
            readMoreLink: '',
        ...
        },
        {
            ...
            images: ['https://thumb.tildacdn.com/tild3862-6339-4735-a539-356335633039/-/format/webp/tour.png'],
            popUp: true,
            popUpType: 'service',
            readMoreLink: '',
            readMoreText: 'Подробнее',
