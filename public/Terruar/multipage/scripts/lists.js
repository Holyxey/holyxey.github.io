const lists = {
  servicesList: [
    ...
    // Летний кинотеатр
    {
      ...
      header: '',
      price: '',
      shortDescr: 'Бесплатно по записи',
      fullDescr:
        'Крытый кинотеатр на свежем воздухе. Идеально подойдет для вечернего просмотра фильмов, или спортивных событий.',
      benefits: ['', '', ''],
      images: [
        'https://thumb.tildacdn.com/tild3936-3231-4830-a330-626331343064/-/format/webp/cinema.png',
      ],
      popUp: true,
      popUpType: 'service',
      readMoreLink: '',
    ...
    // Баня с фурако
    {
      ...
      shortDescr: 'От 2000р/час',
      fullDescr:
        'Баня c санузлом и душем. Дополнительно можно добавить горячую купель фурако и холодную купель. Целый СПА-комплекс.',
      benefits: ['', '', ''],
      images: [
  ...
  faq: {
    ...
    'Какое питание у нас предусмотрено?': `У нас множество вариантов питания &#x1F60A; Прямо у администратораможно приобрести небольшой завтрак или пиццу. 
      <br>А еще при бронировании можно заказать продукты, которые будут ждать вас в холодильнике в домике (даже готовую еду, например, суп).
      <br>Можно заказать бесплатную доставку из ВкусВилл, если что-то забыли (доедет в течение 4х часов)
      <br><br>Напоминаем, что для каждого домика предусмотрена мангальная зона и небольшая кухня со всеми принадлежностями — если захочется приготовить самим.
      <br>А если готовить совсем не хочется, в шаговой доступности у нас есть действующий ресторан, а в 15-30 минутах на машине — еще три ресторана.`,
  ...
  houses: [
    // title: 'Валенсия',
    {
      ...
      images: {
        summer: [
          'https://thumb.tildacdn.com/tild6533-3066-4631-a564-626137336265/-/format/webp/DSC09606.jpg',
    ...
    // title: 'Медок',
    {
      title: 'Медок',
      description: [
        'Четырехместный уютный домик — Медок.',
      ...
      images: {
        summer: [
          'https://thumb.tildacdn.com/tild3235-3466-4839-b063-633731343064/-/format/webp/Medoc02_Large.jpeg',
          'https://thumb.tildacdn.com/tild6139-3265-4538-a136-653262336331/-/format/webp/Medoc01_Large.jpeg',
          'https://thumb.tildacdn.com/tild6261-6163-4536-b165-303563356665/-/format/webp/Medoc03_Large.jpeg',
          'https://thumb.tildacdn.com/tild3835-3264-4435-b437-353434316130/-/format/webp/Medoc04_Large.jpeg',
          'https://thumb.tildacdn.com/tild6637-6166-4534-b865-616236376164/-/format/webp/Medoc05_Large.jpeg',
          'https://thumb.tildacdn.com/tild3161-3363-4263-b566-623538623539/-/format/webp/Medoc06_Large.jpeg',
          'https://thumb.tildacdn.com/tild3638-3834-4366-b133-333966376139/-/format/webp/Medoc07_Large.jpeg',
          'https://thumb.tildacdn.com/tild3063-6665-4131-b830-313566353332/-/format/webp/Medoc08_Large.jpeg',
          'https://thumb.tildacdn.com/tild3435-6535-4139-a639-323566653363/-/format/webp/Medoc09_Large.jpeg',
          'https://thumb.tildacdn.com/tild3964-6164-4832-b235-353261666262/-/format/webp/Medoc010_Large.jpeg',
          'https://thumb.tildacdn.com/tild3466-3561-4930-b436-663134666566/-/format/webp/Medoc011_Large.jpeg',
          'https://thumb.tildacdn.com/tild6430-6465-4730-b234-303365633633/-/format/webp/Medoc012_Large.jpeg',
          'https://thumb.tildacdn.com/tild3238-6236-4061-b639-646664356462/-/format/webp/Medoc013_Large.jpeg',
          'https://thumb.tildacdn.com/tild6566-3764-4261-b730-623537376165/-/format/webp/Medoc014_Large.jpeg',
          'https://thumb.tildacdn.com/tild6334-3639-4231-a238-316261323361/-/format/webp/Medoc015_Large.jpeg',
          'https://thumb.tildacdn.com/tild3534-3734-4261-a364-303839633663/-/format/webp/Medoc016_Large.jpeg',
          'https://thumb.tildacdn.com/tild3066-6362-4331-b564-393139616231/-/format/webp/Medoc017_Large.jpeg',
          'https://thumb.tildacdn.com/tild3162-3932-4238-b438-373064323362/-/format/webp/Medoc018_Large.jpeg',
          'https://thumb.tildacdn.com/tild3231-3939-4136-a235-383166356237/-/format/webp/Medoc019_Large.jpeg',
        ],
        winter: [
          'https://thumb.tildacdn.com/tild3235-3466-4839-b063-633731343064/-/format/webp/Medoc02_Large.jpeg',
          'https://thumb.tildacdn.com/tild6139-3265-4538-a136-653262336331/-/format/webp/Medoc01_Large.jpeg',
...
const iconLinks = {
  ...
  personsGroup:
    'https://api.iconify.design/solar:users-group-two-rounded-line-duotone.svg',
  area: 'https://api.iconify.design/solar:maximize-square-minimalistic-line-duotone.svg',
};
