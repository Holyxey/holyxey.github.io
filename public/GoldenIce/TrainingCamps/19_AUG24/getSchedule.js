const schedule = {
    ...
    scheduleButtons: function () {
        let buttons = document.querySelectorAll('a[data-id]')
    ...
    arenas: [
        {
            ...
            schedule: [
                [
                    ['','Новички и юный фигурист<br>(1+1 час днем)','Закрыть'],
                    ['18.08', 'Лёд, зал', '13:00-14:00 зал<br>14:15-15:15 лёд'],
                    ...
                    ['24.08', '', 'Выходной'],
                    ['25.08', 'Лёд, зал', '13:00-14:00 зал<br>14:15-15:15 лёд'],
        ...
        },
        {
            ...
            schedule: [
                ...
                [
                    ['','Новички и юный фигурист<br>(1,5+1,5 часа днем)','Закрыть'],
                ...
                [
                    ['','Новички и юный фигурист<br>(1+1 час утром)','Закрыть'],
                    ['18.08', 'Лёд, зал', '09:15-10:15 лед<br>10:30-11:30 зал'],
                    ...
                    ['24.08', '', 'Выходной'],
                    ['25.08', 'Лёд, зал', '09:15-10:15 лед<br>10:30-11:30 зал'],
