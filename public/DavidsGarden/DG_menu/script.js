  ...
  let tabsByGDocs = [
    {
      language: 'ქართული',
      preview:
        'https://drive.google.com/file/d/1fVh3pYkQj-v6GipH91OzXTC96xYlf-Xw/preview',
      // 'https://drive.google.com/file/d/1Y3YUcjBbBUHVfqixKNK2XzbOu2jqrQNP/preview',
    },
    {
      language: 'English',
      preview:
    ...
    },
    {
      language: 'Русский',
      preview:
        'https://drive.google.com/file/d/1J7Lz28dgIUK5FaiSdVQoXwY2pKliT-6P/preview',
      // 'https://drive.google.com/file/d/1M4n4h98E9dcFMlabwFXHeKoaGKkL9Rb5/preview'
    },
  ];
  try {
    !document.getElementById('tabsMenu')
      ? document
          .getElementById(pasteAfterRecId)
          .insertAdjacentHTML('afterend', '<section id="tabsMenu"> </section>')
      : null;
    ...
    tabsByGDocs.forEach((doc) => {
      ...
      tabsNode.insertAdjacentHTML(
        'beforeend',
        `<button data-iframe="${doc.language}">${doc.language}</button>`
      );
      menusNode.insertAdjacentHTML(
        'beforeend',
        `<iframe data-iframe="${doc.language}" src="${doc.preview}"></iframe>`
      );
    });
