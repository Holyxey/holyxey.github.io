...
if (staff_node) {
	...
	function render_person(p: People): void {
		...
		name.className =
			"transition-all! duration-500! font-bold! text-xl! pt-2! m-0! text-neutral-600! group-hover:-translate-y-2! ";

		descr.className =
			"transition-all! duration-400! text-neutral-800! p-0! m-0! group-hover:-translate-y-3!";
