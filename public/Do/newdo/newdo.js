...
const randomBodyBack = () => {
    ...
    let images = ['https://thumb.tildacdn.com/tild3736-6437-4531-a234-396638353763/-/format/webp/Movement.jpeg',
    ...
    b.style.cssText =
        `background-image: url('${images[randomNumber(images.length)]}')`
}
...
const desktopImage = () => {
    ...
    let imageList = ['https://thumb.tildacdn.com/tild3736-6437-4531-a234-396638353763/-/format/webp/Movement.jpeg',
        'https://thumb.tildacdn.com/tild3432-6132-4431-b363-663537666335/-/format/webp/Freedom.jpeg',
        'https://thumb.tildacdn.com/tild6436-3662-4865-b563-653263306338/-/format/webp/Love.jpeg',]
...
const hideHOne = () => {
    if (document.querySelector('h1')) {
        ...
        hh.style.cssText =
            `
            translate: 0 -${hh.getBoundingClientRect().height}px;
            `
    }
}
